...
void DrawModelPBR(Model model, Vector3 position, float scale, Color tint)
{
...
void DrawModelPBREx(Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle, Vector3 scale, Color tint)
{
    ...
    {
        DrawMeshPBR(model.meshes[i], model.materials[model.meshMaterial[i]], model.transform);
    }
}
